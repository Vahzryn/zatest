  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-6 py-2 sm:py-6 animate-in fade-in duration-200">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="max-w-2xl mx-auto text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 font-normal leading-relaxed">
      ...
      >
        <div 
          ...
          className="inline-flex sm:grid sm:grid-cols-6 items-center gap-1.5 p-1 rounded-xl bg-zinc-100/70 dark:bg-zinc-800/50 border border-zinc-200/80 dark:border-zinc-800 w-auto sm:w-full min-w-max sm:min-w-0"
        >
          {ALL_CATEGORY_KEYS.map((catKey) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "group relative flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] cursor-pointer select-none shrink-0 sm:shrink min-h-[38px] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50 motion-reduce:transition-none motion-reduce:transform-none",
                  isActive
                    ...
                    : "text-zinc-600 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-white/80 dark:hover:bg-zinc-800/60 border border-transparent hover:border-zinc-200/80 dark:hover:border-zinc-700/80 hover:-translate-y-px"
                )}
              >
                <Icon className={cn(
                ...
                <span className={cn(
                  "text-[10px] px-1.5 py-0.2 rounded-full transition-colors duration-200",
                  isActive
                    ? "bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-300 font-bold"
                    : "bg-zinc-200/60 dark:bg-zinc-700/60 text-zinc-500 dark:text-zinc-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-300"
                )}>
                  {count}
                </span>
              </button>
      ...
      {/* 2. Search & Filter Bar */}
      <div className="p-2.5 sm:p-3 rounded-xl bg-white dark:bg-zinc-900/50 border border-zinc-200/80 dark:border-zinc-800">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-14 py-2 text-xs sm:text-sm bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500/50 transition-all duration-200"
          />
          {searchQuery && (
            <button
              type="button"
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-zinc-200/80 dark:border-zinc-800 pb-3">
          ...
          {(selectedCategory !== 'all' || searchQuery) && (
            <button
              ...
              className="inline-flex items-center gap-1 text-xs font-semibold text-zinc-500 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors cursor-pointer self-start sm:self-center"
        ...
        >
          {filteredTools.length === 0 ? (
            <div className="p-8 sm:p-12 text-center bg-white dark:bg-zinc-900/50 rounded-xl border border-zinc-200/80 dark:border-zinc-800 space-y-3">
              ...
              {filteredTools.map((tool) => {
                ...
                return (
                  <a
                    ...
                    className="group relative flex flex-col justify-between p-4 rounded-xl bg-white dark:bg-zinc-900/50 border border-zinc-200/80 dark:border-zinc-800 text-left transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-zinc-300 dark:hover:border-zinc-700 hover:shadow-xs hover:-translate-y-0.5 active:scale-[0.98] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50 motion-reduce:transition-none motion-reduce:transform-none"
                  >
                    <div className="space-y-2.5">
                      <div className="flex items-center justify-between">
                        <div className="w-8 h-8 rounded-lg bg-zinc-100 dark:bg-zinc-800/80 text-zinc-500 dark:text-zinc-400 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-950/40 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 flex items-center justify-center transition-colors duration-200 shrink-0">
                          <ToolIcon className="w-4 h-4" />
                        </div>
                        <div className="flex items-center gap-1.5">
                          <span className="text-[10px] font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800/80 px-2 py-0.5 rounded">
                            {catDef.title}
                          </span>
                          <ArrowRight className="w-3.5 h-3.5 text-zinc-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-all duration-200 group-hover:translate-x-0.5" />
                        </div>
                      </div>

                      <div className="space-y-1">
                        <h3 className="text-xs sm:text-sm font-bold text-zinc-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-200 leading-snug">
                          {tool.name}
                        </h3>
