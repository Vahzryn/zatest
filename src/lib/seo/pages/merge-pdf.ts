...
export function getPageSeo(fullUrl: string, path: string): SeoRouteData {
  ...
  return {
    ...
    metaDescription: 'Combine multiple PDF documents into one single file securely in your browser. Client-side local processing with zero server uploads.',
    ...
    guideContent: {
      ...
      section1Title: 'Secure, Local PDF Combination',
      section1Body: 'Zapixal Merge PDF operates directly in browser memory, keeping your documents, contracts, and records locally on your device without server uploads.',
